      ...
      <main className="container mx-auto px-4">
        <section className="pt-32 md:pt-40 pb-16 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto font-lato">
            Specialized bookkeeping and financial management services designed for churches 
            and religious organizations. From donation tracking to ministry budgeting.
          </p>
        </section>
