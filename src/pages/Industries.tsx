  ...
  return (
    <div className="min-h-screen bg-[#121212]">
      <Helmet>
        ...
        <meta name="description" content="AI Bookkeeping serves diverse industries with tailored financial solutions. From healthcare to e-commerce, we optimize bookkeeping for your specific needs." />
        ...
        <meta property="og:description" content="AI Bookkeeping serves diverse industries with tailored financial solutions. From healthcare to e-commerce, we optimize bookkeeping for your specific needs." />
