...
export const IndustryCard = ({ title, description, icon: Icon }: IndustryCardProps) => {
  return (
    <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-[#4A2384] to-[#2A1364] border border-primary/30 hover:border-primary transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-2">
      ...
      <div className="relative p-8 flex flex-col items-center text-center z-10">
        {/* Icon container with enhanced 3D effect and glow */}
        ...
        {/* Title with enhanced visibility and gradient effect */}
